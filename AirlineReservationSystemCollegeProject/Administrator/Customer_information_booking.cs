...
namespace AirlineReservationSystemCollegeProject.Administrator
{
    public partial class Customer_information_booking : Form
    {
        ...
        {
            con.Open();
            string query="INSERT INTO CustomerTbl insertion (CustId,CustName,CustPassport,CustAd,CustNat,CustGend,CustPhone) VALUES ('"+CustID.Text+ "','" + CustName.Text + "','" + CustPassport.Text + "','" + CustAd.Text + "','" + NationalityCb.Text + "','" + GenderCb.Text + "','" + PhoneTb.Text + "')";
